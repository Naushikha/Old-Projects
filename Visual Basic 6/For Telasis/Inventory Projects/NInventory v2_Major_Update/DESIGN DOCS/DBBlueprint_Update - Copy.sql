...
ALTER TABLE `prod_name` ADD CONSTRAINT `prod_name_fk0` FOREIGN KEY (`catId`) REFERENCES `prod_category`(`id`);

ALTER TABLE `sProduct` ADD CONSTRAINT `sProduct_fk0` FOREIGN KEY (`pnId`) REFERENCES `prod_name`(`id`);

ALTER TABLE `sProduct` ADD CONSTRAINT `sProduct_fk1` FOREIGN KEY (`supplierId`) REFERENCES `supplier`(`id`);

ALTER TABLE `sProduct` ADD CONSTRAINT `sProduct_fk2` FOREIGN KEY (`customerId`) REFERENCES `customer`(`id`);

ALTER TABLE `nsProduct` ADD CONSTRAINT `nsProduct_fk0` FOREIGN KEY (`pnId`) REFERENCES `prod_name`(`id`);
