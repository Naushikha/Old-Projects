...
If Int(txtQ.Text) <= prodTemp(cmbProd.ListIndex) And Int(txtQ.Text) <> 0 Then
...
Print #tmpFile, "-----Inventory_after_sale-----"
For i = 0 To (prodTotal - 1)
Print #tmpFile, prod(i).name & "," & prod(i).quantity
Next
Close #tmpFile
